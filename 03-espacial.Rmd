...
*   Principalmente utilizados en el contexto de la estadística y la econometría espacial.
    
*   Una amplia gama de modelos. Es posible encontrar los SAR equivalentes a Probit,
    Logit, MLogit, etc.
...
*   Una propiedad importante e interesante es que $(I_n - \rho W)^{-1}$
    ...
    los vecinos directos: $I_n + \rho W + \rho^2 W^2 + \dots$ (*power graph*)
